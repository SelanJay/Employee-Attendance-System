...
<div class="sidebar">
    ...
    <a href="manageProfile.jsp">
        <i class="bi bi-person-lines-fill"></i> Manage Profiles
    </a>

    <a href="manageAttendance.jsp">
        <i class="bi bi-calendar-check"></i> Manage Attendance
    </a>

    <a href="MonthlyReportForm.jsp">
        <i class="bi bi-clipboard-data-fill"></i> View Attendance Record
    </a>
